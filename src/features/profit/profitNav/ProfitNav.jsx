...
export default function ProfitNav({ setShowChart }) {
  ...
  return (
    <div>
      ...
      >
        <div className={classes.topNavbarProfitContainer}>
          <div className={classes.topNavbarProfitLeftCol}>
            <Navbar.Brand className={classes.topNavbarBrand} href="#home">
              Profit
            </Navbar.Brand>
          </div>
          <div className={classes.topNavbarProfitRightCol}>
            <Button.Group
              size="small"
